...
**Stateful Filtering**  
The project gallery is governed by local React state. When a user selects a sector (e.g., _Commercial_, _Residential_, _Infrastructure_), the list is filtered on-the-fly and paginated dynamically. This keeps the interaction feeling instantaneous and lag-free.
